...
from environment import create_box, create_cliff, create_target, create_wall
...
class CliffBoxPushingTask(BaseTask):
    ...
    def post_reset(self) -> None:
        ...
        action = ArticulationAction(joint_positions=None, joint_efforts=None, joint_velocities=torch.tensor([-10, 10], dtype=torch.float32))
